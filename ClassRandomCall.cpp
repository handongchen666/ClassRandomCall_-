// ClassRandomCall - Open Source Edition
// A lightweight classroom random name picker for Windows.
...
LRESULT CALLBACK MainWndProc(HWND hwnd, UINT msg, WPARAM wParam, LPARAM lParam) {
    ...
    case WM_COMMAND:
        ...
        case IDC_BTN_PICK: {
            ...
            else if (g_config.students.empty()) {
                SetDlgItemTextW(hwnd, IDC_MAIN_DISPLAY, L"No students. Go to Settings to add.");
            }
            else {
